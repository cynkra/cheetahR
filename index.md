...
So far, [`cheetah()`](reference/cheetah.md) is available to render a
dataframe in R
...
2.  Right-click on the widget and navigate to the “inspect” option on
    ...
    browser](reference/figures/image1.png)
3.  At the top, where the tabs are displayed, navigate to the “Sources”
    ...
    script ![Inspector tabs are opened](reference/figures/image2.png)
4.  Once the “cheetah.js” is opened on the main panel. You can set a
    ...
    ![The breakpoint is shown](reference/figures/image3.png)
