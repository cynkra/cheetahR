...
- [`add_cell_message()`](add_cell_message.md) : Create a JavaScript cell
  message function for cheetahR widgets
- [`add_row()`](add_row.md) : Add a row to a cheetah table
- [`cheetahOutput()`](cheetah-shiny.md)
...
- [`number_format()`](number_format.md)
  [`date_format()`](number_format.md) : Column formatter
